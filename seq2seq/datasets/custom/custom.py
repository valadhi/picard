...
class CustomSpider(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager: datasets.DownloadManager) -> List[datasets.SplitGenerator]:
        downloaded_filepath = "/app/seq2seq/database/insurance/"
        ...
        return [
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "data_filepaths": [
                        os.path.join(downloaded_filepath, "insurance.json"),
                    ],
            ...
            with open(data_filepath, encoding="utf-8") as f:
                ...
                for idx, sample in enumerate(spider):
                    ...
                    yield idx, {
                        ...
                        "db_id": db_id,
                        "db_path": db_path,
                        "db_table_names": spider_config["db_table_names"],
                        "db_column_names": spider_config["db_column_names"],
                        ...
                        # ],
                        # "db_foreign_keys": spider_config["db_foreign_keys"]
                    }
